...
class AudioService {
  ...
  final List<AudioPlayer> _animals = [
    AudioPlayer(),
    AudioPlayer(),
    AudioPlayer(),
  ];

  // fishing sound players
  ...
  Future<void> _play(AudioPlayer player, String relPath) async {
    if (!_enabled) return;
    ...
    try {
      ...
      await player.play(AssetSource(relPath));
    } catch (e) {
      debugPrint('[Audio] Cannot play $relPath – $e');
    }
  }
